...
<div class="row top_bg" style="width:100%">
		...
		<div class="modal-content">
			<div class="row no-gutters">
				<div class="text-center" style="width:100%;">
					<h2 style="padding: 50px;"><span style="color:#7DC3BB;font-size:40px;">Hotel</span> 정보를 가져오는 중 <img src="${initParam.IMG_SERVER_PATH }/image/loading-dot.gif" width="50px"></h2>
				</div>
			</div>
			<div class="row no-gutters">
				<div class="text-center" style="width:100%;">
					<img style="padding-bottom: 50px;" src="${initParam.IMG_SERVER_PATH }/image/giphy.gif" width="100%" height="100%">
				</div>
			</div>
		</div>
	</div>
