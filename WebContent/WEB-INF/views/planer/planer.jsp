		...
		<div class="col-md-4 col-xs-12" style="position: relative;">
			<form id="planerForm" onsubmit="false">
				<div class="form-group">
					<label for="name" class="planer-label"><span
						class="planer-label-icon" data-feather="compass"></span><span
						class="planer-label-title">여행 제목</span></label> <input type="text"
						class="form-control" id="title" name="title"
						placeholder="Ex) 먹방 대만 여행">
				</div>
				<div class="form-group">
					<label for="location" class="planer-label"><span
						class="planer-label-icon" data-feather="map"></span><span
						class="planer-label-title">여행 지역</span></label> <select
				...
				<div class="form-group">
					<label for="from_date" class="planer-label"><span
						class="planer-label-icon" data-feather="briefcase"></span><span
				...
				<div class="form-group">
					<input type="hidden" value="" id="paper" name="paper"> <label
						for="paper" class="planer-label"><span
						class="planer-label-icon" data-feather="book"></span><span
			...
			<div class="next-button d-flex justify-content-center"
	...
	function checkDateRange() {
		...
		if (from > to) {
			$('#from_date')
					.parent()
					.append(
							'<span style="font-size:80%;color:#dc3545;">출발 일자와 도착 일자를 확인해주세요.</span>');
			$('#from_date').focus();
			result = false;
		} else {
